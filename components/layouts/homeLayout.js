...
export default function HomeLayout({ children }) {
  ...
  return (
    <>
      <main className='h-screen w-full bg-cover bg-[right_20%_top_50%] bg-landing-background-alt'>
        <div className="flex justify-center sm:justify-start gap-4 sm:gap-8 py-5 px-6 sm:px-12 text-xl font-semibold font-allrounder text-white">
