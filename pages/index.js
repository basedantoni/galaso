      ...
      <div className='w-full h-full'>
        ...
        <main className='relative flex justify-center items-center h-screen'>
          <a href="https://too.fm/n2n8ne2" target="_blank" rel="noreferrer">
            <p className='[text-shadow:_0_-4px_16px_rgb(0_0_0_/_100%)] cursor-pointer absolute tracking-tighter text-white top-1/3 right-16 sm:left-[15%] flex flex-col items-end sm:items-start font-allrounder font-bold text-2xl sm:text-2xl'>
